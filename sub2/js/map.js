 window.onload = function() {
    ...
    var options = {
        center: new daum.maps.LatLng(37.50902703487773, 127.02269133706805),
        level: 2
    };
    ...
    var markerPosition  = new daum.maps.LatLng(37.50902703487773, 127.02269133706805); 
    ...
    var options2 = {
        center: new daum.maps.LatLng(37.56111974865063, 126.98604466701974),
        level: 2
    };
    ...
    var markerPosition2  = new daum.maps.LatLng(37.56111974865063, 126.98604466701974); 
   ...
   var options3 = {
       center: new daum.maps.LatLng(37.540875582638, 127.06843674899585),
       level: 2
   };
   ...
   var markerPosition3  = new daum.maps.LatLng(37.540875582638, 127.06843674899585); 
   ...
   var options4 = {
       center: new daum.maps.LatLng(37.55375954276835, 126.92368893097361),
       level: 2
   };
   ...
   var markerPosition4  = new daum.maps.LatLng(37.55375954276835, 126.92368893097361); 
